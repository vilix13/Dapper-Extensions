...
namespace DapperExtensions.Sql
{
    public interface ISqlGenerator
    {
        ...
        string Update(IClassMapper classMap, IPredicate predicate, IDictionary<string, object> parameters, string[] propsToUpdate = null);
    ...
    public class SqlGeneratorImpl : ISqlGenerator
    {
        ...
        public virtual string Update(IClassMapper classMap, IPredicate predicate, IDictionary<string, object> parameters, string[] propsToUpdate)
        {
            if (predicate == null)
            {
