...
namespace DapperExtensions
{
    public interface IDatabase : IDisposable
    {
        ...
        bool Update<T>(T entity, IDbTransaction transaction, int? commandTimeout = null, string[] propsToUpdate = null) where T : class;
        bool Update<T>(T entity, int? commandTimeout = null, string[] propsToUpdate = null) where T : class;
    ...
    public class Database : IDatabase
    {
        ...
        public bool Update<T>(T entity, IDbTransaction transaction, int? commandTimeout, string[] propsToUpdate) where T : class
        {
            return _dapper.Update<T>(Connection, entity, transaction, commandTimeout, propsToUpdate);
        }

        public bool Update<T>(T entity, int? commandTimeout, string[] propsToUpdate) where T : class
        {
            return _dapper.Update<T>(Connection, entity, _transaction, commandTimeout, propsToUpdate);
        }
